...
#define LCD_DCX_GPIO_PIN                    GPIO_PIN_4
...
#define LCD_RST_LOW()                       WRITE_REG(GPIOD->BSRR, (uint32_t)GPIO_PIN_4 << 16)
...
#define LCD_DC_HIGH()                       WRITE_REG(GPIOB->BSRR, (uint32_t)GPIO_PIN_4 << 16)
